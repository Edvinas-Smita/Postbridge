...
public class ParcelsController
{
    ...
    @PostMapping
    public ResponseEntity<Parcel> createParcel(@RequestBody @Valid Parcel parcel)  //CREATE
    {
        ...
        if (parcel.getRecipient().getId() == null ||
                    parcelsService.getUser(parcel.getRecipient().getId()) == null)
        {
    ...
    @GetMapping(path = "/{id}")
    public ResponseEntity<Parcel> getParcel(@PathVariable("id") long id)    //READ
    {
    ...
    @GetMapping
    public ResponseEntity<List<Parcel>> getParcels()    //READ
    {
    ...
    @PutMapping
    public ResponseEntity updateParcel(@RequestBody Parcel parcel)  //UPDATE
    {
    ...
    @PutMapping(path = "/{id}")
    public ResponseEntity updateParcel(@PathVariable("id") long id, @RequestBody Parcel parcel) //UPDATE
    {
    ...
    @DeleteMapping("/{id}")
    public ResponseEntity<Parcel> deleteParcel(@PathVariable("id") long id) //DELETE
    {
